...
export default function StaticsStep({ typer }: StaticsStepProps) {
  return (
    <div>
      <Eyebrow>Этап 1 · Признак 3 (перепроверка)· Тальность (статика/динамика))</Eyebrow>
      ...
      <HintBox title="Уточняющие вопросы">
        <div className={styles.hintList}>
          ...
          <div className={styles.hintTitle}>Важно ли вам, когда рассказываете историю, соблюдать ее хронологию? </div>
          <div className={styles.hintDesc}>
            Если важно по порядку все рассказать — динамик. Если прыгаете с события на событие (даже возвращаясь к теме) — статик. 
          </div>
          <Divider />
