...
export default function SidebarSummary({
  ...
  return (
    <div className={styles.root}>
      ...
      <ValueRow label="Нальность" value={labels.rationalLabel} />
      <ValueRow label="Вертность" value={labels.extroLabel} />
      <ValueRow
        label="Тальность"
        value={labels.staticsLabel}
        fail={talMatch === false}
      />
      <ValueRow label="Позитивизм" value={labels.posLabel} />
      <ValueRow label="Проц/Рез" value={labels.procLabel} />
